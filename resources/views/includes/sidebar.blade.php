<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        @can('admin')
            <li
                class="nav-item dropdown {{ Route::is('auditor*') || Route::is('admin*') || Route::is('prodi*') || Route::is('fakultas*') ? 'active' : '' }}">
            ...
            <li
                class="nav-item dropdown {{ Route::is('nilai*') || Route::is('ami*') || Route::is('tahun*') || Route::is('standar*') || Route::is('pertanyaan*') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown">
