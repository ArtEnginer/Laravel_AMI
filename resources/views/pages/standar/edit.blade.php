...
@section('content')
    <form action="{{ route('standar.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea style="height: 200px" class="form-control summernote-simple @error('value') is-invalid @enderror"
                                    name="value" id="value" placeholder="Isi Standar">{{ old('value', $item->value) }}</textarea>
                                @error('value')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
