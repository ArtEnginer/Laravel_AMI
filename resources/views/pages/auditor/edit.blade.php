...
@section('content')
    <form action="{{ route('auditor.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('study_program_id') is-invalid @enderror"
                                    ...
                                    @foreach ($studyPrograms as $sp)
                                        <option {{ $item->study_program_id == $sp->id ? 'selected' : '' }}
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('faculty_id') is-invalid @enderror" name="faculty_id"
                                    ...
                                    @foreach ($faculties as $f)
                                        <option {{ $item->faculty_id == $f->id ? 'selected' : '' }}
